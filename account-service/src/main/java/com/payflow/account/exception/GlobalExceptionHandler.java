...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleIllegalState(IllegalStateException ex) {
        ...
        body.put("error", "Conflict / Processing Error");
        body.put("message", ex.getMessage());
    ...
    public ResponseEntity<?> handleOptimisticLockingFailure(ObjectOptimisticLockingFailureException ex) {
        ...
        body.put("error", "Precondition Failed / Optimistic Lock Failure");
        body.put("message", "The account was updated concurrently. Please retry your operation.");
